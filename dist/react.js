...
function CacheShieldProvider(_a) {
    ...
    var shield = require$$0.useState(function () { return new CacheShield(config); })[0];
    var _b = require$$0.useState(false), isClearing = _b[0], setIsClearing = _b[1];
    var _c = require$$0.useState(null), lastResult = _c[0], setLastResult = _c[1];
...
function useCacheShieldSimple(config) {
    var _this = this;
    var shield = require$$0.useState(function () { return new CacheShield(config); })[0];
    var _a = require$$0.useState(false), isClearing = _a[0], setIsClearing = _a[1];
    var _b = require$$0.useState(null), lastResult = _b[0], setLastResult = _b[1];
    var clear = require$$0.useCallback(function (options) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
