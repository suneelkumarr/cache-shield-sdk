...
var CacheShieldContext = require$$0.createContext(null);
function CacheShieldProvider(_a) {
    var _this = this;
    var children = _a.children, config = _a.config;
    var _b = __read(require$$0.useState(function () { return new CacheShield(config); }), 1), shield = _b[0];
    var _c = __read(require$$0.useState(false), 2), isClearing = _c[0], setIsClearing = _c[1];
    var _d = __read(require$$0.useState(null), 2), lastResult = _d[0], setLastResult = _d[1];
    var clear = require$$0.useCallback(function (options) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var clearType = require$$0.useCallback(function (type) { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var hardReload = require$$0.useCallback(function () {
        shield.hardReload();
    }, [shield]);
    var value = {
        shield: shield,
...
function useCacheShield() {
    var context = require$$0.useContext(CacheShieldContext);
    if (!context) {
...
function useCacheShieldSimple(config) {
    var _this = this;
    var _a = __read(require$$0.useState(function () { return new CacheShield(config); }), 1), shield = _a[0];
    var _b = __read(require$$0.useState(false), 2), isClearing = _b[0], setIsClearing = _b[1];
    var _c = __read(require$$0.useState(null), 2), lastResult = _c[0], setLastResult = _c[1];
    var clear = require$$0.useCallback(function (options) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.CacheShieldProvider = CacheShieldProvider;
exports.ClearCacheButton = ClearCacheButton;
exports.useCacheShield = useCacheShield;
exports.useCacheShieldSimple = useCacheShieldSimple;
