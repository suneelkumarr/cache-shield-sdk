...
function CacheShieldProvider(_a) {
    ...
    var shield = useState(function () { return new CacheShield(config); })[0];
    var _b = useState(false), isClearing = _b[0], setIsClearing = _b[1];
    var _c = useState(null), lastResult = _c[0], setLastResult = _c[1];
...
function useCacheShieldSimple(config) {
    ...
    var _b = useState(null), lastResult = _b[0], setLastResult = _b[1];
    var clear = useCallback(function (options) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
