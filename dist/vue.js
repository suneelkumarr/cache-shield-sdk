...
// Injection key
var CacheShieldKey = Symbol('CacheShield');
// Composable factory
function createCacheShield(config) {
    var shield = new CacheShield(config);
    var isClearing = vue.ref(false);
    var lastResult = vue.ref(null);
    var capabilities = vue.reactive(shield.getCapabilities());
    ...
    function clearAndReload(options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, clear(options)];
                    case 1:
                        _a.sent();
                        hardReload();
                        return [2 /*return*/];
    ...
    return {
        shield: shield,
        isClearing: vue.readonly(isClearing),
        lastResult: vue.readonly(lastResult),
        capabilities: vue.readonly(capabilities),
        clear: clear,
        clearType: clearType,
...
// Vue plugin
function CacheShieldPlugin(app, config) {
    var cacheShield = createCacheShield(config);
...
function useCacheShield() {
    var cacheShield = vue.inject(CacheShieldKey);
    if (!cacheShield) {
        throw new Error('CacheShield not found. Did you install the CacheShieldPlugin?');
    }
    return cacheShield;
}
...
exports.CacheShieldKey = CacheShieldKey;
exports.CacheShieldPlugin = CacheShieldPlugin;
exports.createCacheShield = createCacheShield;
exports.default = CacheShieldPlugin;
