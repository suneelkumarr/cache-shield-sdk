...
function createCacheShield(config) {
    ...
    var isClearing = ref(false);
    var lastResult = ref(null);
    var capabilities = reactive(shield.getCapabilities());
...
function useCacheShield() {
    var cacheShield = inject(CacheShieldKey);
    if (!cacheShield) {
...
export { CacheShieldKey, CacheShieldPlugin, createCacheShield, CacheShieldPlugin as default, useCacheShield, useCacheShieldSimple };
